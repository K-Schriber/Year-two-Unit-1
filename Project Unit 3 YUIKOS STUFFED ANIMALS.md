...
|-------------------------------------------------------------------|---------------------------------|-----------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|
| Test if signup page works                                         | Functional                      | 1. "Register", 2, Yuiko, yuiko@uwcisak.jp, yuoko for password text fields, 3. Press "Submit". | If successful should bring to main page.                                    |
| Test if login page works                                          | Functional                      | 1. Enter Yuiko into "username" enter password yuoko, 2. Press "Login".                        | Should bring the user to Homescreen                                         |
| Testing if adding new customer works                              | Functional: Integration testing | 1. Jeff, 2. enter Phone - 801-750, 3. Amount of animals : 1Press Submit                       | Should be added to drop down table including time and id number of customer |
| Check if the code has good comments, variables, and method names. | Non-functional                  | N/A                                                                                           | The code contains easy understing codenames                                 |
| Check if database table Users is saving correctly                 | Non-functional                  | n/A                                                                                           | The table should have the exact data as in database.                        |
